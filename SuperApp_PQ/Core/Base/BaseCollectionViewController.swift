...
/// prefer `BaseTableViewController`.
class BaseCollectionViewController<ViewModel: BaseViewModel>: BaseViewController<ViewModel>, UICollectionViewDelegate {
    ...
    /// Compatibility override point used by older `BaseListViewController` subclasses.
    ...
    /// Register collection cells and supplementary views before datasource setup.
