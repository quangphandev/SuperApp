...
/// Usage:
/// ```swift
/// class EnglishHomeViewController: BasePagingViewController<EnglishHomeViewModel> {
///     override var pages: [PageItem] {
///         [
///             PageItem(title: "Từ vựng",   viewController: { VocabViewController(viewModel: ...) }),
///             PageItem(title: "Ngữ pháp",  viewController: { GrammarViewController(viewModel: ...) }),
///             PageItem(title: "Phát âm",   viewController: { PronounViewController(viewModel: ...) }),
///         ]
///     }
/// }
/// ```
class BasePagingViewController<ViewModel: BaseViewModel>: BaseViewController<ViewModel>, UIScrollViewDelegate {
