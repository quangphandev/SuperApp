...
/// Usage:
/// ```swift
/// class PolicyWebViewController: BaseWebViewController<PolicyViewModel> {
///
...
/// }
/// ```
class BaseWebViewController<ViewModel: BaseViewModel>: BaseViewController<ViewModel>, WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
