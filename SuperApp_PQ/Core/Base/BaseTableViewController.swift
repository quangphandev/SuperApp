...
/// `BaseCollectionViewController` instead.
class BaseTableViewController<ViewModel: BaseViewModel>: BaseViewController<ViewModel>, UITableViewDelegate {
    ...
    /// Register table cells, headers, and footers before datasource setup.
